...
const BasketScreen = () => {
  ...
  const [groupedItemsInBucket, setGroupedItemsInBucket] = useState([]);
  ...
  useMemo(() => {
    ...
    setGroupedItemsInBucket(groupedItems);
  }, [items]);
    ...
    <SafeAreaView className="flex-1 bg-white">
      <View className="flex-1 bg-gray-100">
        ...
        <ScrollView className="divide-y divide-gray-200">
          {Object.entries(groupedItemsInBucket).map(([key, items]) => (
            <View
              key={key}
        ...
        <View className="p-5 bg-white mt-5 space-y-4">
          ...
          <View className="flex-row justify-between">
            ...
            <Text className="text-gray-400">
              <Currency quantity={5000} currency="NGN" />
            </Text>
          </View>
          ...
          <View className="flex-row justify-between">
            ...
            <Text className="font-extrabold">
              <Currency quantity={basketTotal + 5000} currency="NGN" />
            </Text>
          </View>

          <TouchableOpacity className="rounded-lg bg-[#00CC88]">
